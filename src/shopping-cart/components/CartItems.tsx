...
//TODO cambiar product a Product y quitar el string
interface Props {
  product:  Product;
  quantity: number;
}
    ...
    <div className="flex items-center shadow rounded-lg w-full bg-gray-800 border-gray-100">
      ...
      <div className="p-2">
        <Image
            width={200}
            height={200}
            className="rounded min-w-[70px]" 
            src={ product.image }
            alt={ product.name } />
      </div>
      
      {/* Title */}
      <div className="px-2 sm:px-5 pb-5 w-full flex flex-col mt-2 text-center sm:text-start">
        <a href="#">
      ...
      <div className="flex flex-col sm:flex-row p-2 sm:p-5 items-center justify-center">
        <button
          onClick={ onAddToCart }
